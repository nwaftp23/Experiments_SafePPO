...
main("two_lanes_two_way", num_episodes, gamma, lam, Kl_targ, batch_size, HL1_mult, 1.0, True, act_dim, obs_dim, obstacle = True, reward_function = rew_func, render = False)
